...
try:
    ...
    from stage1_pipeline.llm.client import create_llm_client
...
async def main():
    ...
    test_text = "点击这个按钮，可以看到详细信息。然后选择那一项配置。"
    # Corresponding subtitles
    subtitles = [
        MockSubtitle("点击这个按钮，可以看到详细信息。", 0.0, 5.0, "S001"),
        MockSubtitle("然后选择那一项配置。", 5.0, 10.0, "S002")
    ]
