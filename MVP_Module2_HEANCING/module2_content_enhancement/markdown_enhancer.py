...
def test_enhancer():
    ...
    if not enhancer.enabled:
        print("Warning: LLM not enabled, using fallback mode")
    
    print("=" * 80)
    print("Markdown Enhancer Test")
    print("=" * 80)
    
    markdown = enhancer.enhance(result_path, subject="数据结构与算法")
    
    # 保存结果
    output_path = "d:/videoToMarkdownTest2/MVP_Module2_HEANCING/tests/test_data/video_01/rich_text_output/enhanced_output.md"
