...
改进:
1. 增加第四类 "讲解型" (Expository) - 纯概念定义/背景介绍/总结回顾
2. 增加置信度判断
3. 增加不确定性标记
4. 核心描述必须使用动作单元时间范围内的字幕
"""
...
SUBTITLE_PATH = "d:/videoToMarkdownTest2/MVP_Module2_HEANCING/tests/test_data/video_01/step2_correction_output.json"
...
def main():
    ...
    # 保存结果
    output_path = "d:/videoToMarkdownTest2/MVP_Module2_HEANCING/tests/test_data/video_01/action_unit_analysis_v4.json"
