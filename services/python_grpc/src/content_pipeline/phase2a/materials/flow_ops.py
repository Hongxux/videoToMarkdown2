...
_SPLIT_VIDEO_BY_UNIT_MODULE = (
    "services.python_grpc.src.content_pipeline.phase2a.materials.split_video_by_semantic_units"
)
...
async def split_video_by_semantic_units(
    ...
    split_module = _SPLIT_VIDEO_BY_UNIT_MODULE
