...
## 2026-02-05 LLM ????????????? action_units.knowledge_type ??
- ???2026-02-05
- ???`modality_classification_cache.json` ?????????camelCase?unitId/actionId/knowledgeType??? loader ?? snake_case?unit_id/action_id/knowledge_type??????????????????????????? action_units ?? `knowledge_type`?
- ???GenerateMaterialRequests ???? unit ????? CV actionType???????/???????
- ???KnowledgeClassificationOrchestrator.loadFromCache ?? camelCase/snake_case ???????????????VideoProcessingOrchestrator ?????????? WARNING?
- ??????????????????? unitId + knowledgeType ?????????????????
